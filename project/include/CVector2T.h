...
class CVector2
{
    public:
        ...
        T GetAngleRad(const CVector2<T>* v2) const;
        T GetAngleRad2(const CVector2<T>* v2) const;
        T GetAngleSkalarRad(const CVector2<T>* v2) const;
        T GetAngleRadAtan2(const CVector2<T>* v2) const;
